    ...
    if (!customOptions) {
        if (typeof options.preset === 'object') {
            presets.alphabet = options.preset
                ...
                .map(line => line.map(presets_js_1.findKey));
        }
    ...
    return {
        ...
        on(elmentId, config) {
            ...
            const onChange = customOptions.withHeader
                ...
                : config.onChange;
            inputConfig.set(elmentId, Object.assign(Object.assign({}, config), { onChange }));
            const listener = () => {
...
function showKeyboard() {
    ...
    const keyboard = document.getElementById(KEYBOARD_ID);
    if (keyboard) {
        keyboardType = ((_a = inputConfig.get(focusedElementId)) === null || _a === void 0 ? void 0 : _a.keyboardType) || 'alphabet';
...
function onKeyDownListener(event) {
    ...
    if (input) {
        switch (event.key) {
            case 'Backspace':
                (_a = inputConfig.get(focusedElementId)) === null || _a === void 0 ? void 0 : _a.onChange(input.value.slice(0, -1));
                break;
            case 'Delete':
                (_b = inputConfig.get(focusedElementId)) === null || _b === void 0 ? void 0 : _b.onChange('');
                break;
            case 'Enter':
                (_d = (_c = inputConfig.get(focusedElementId)) === null || _c === void 0 ? void 0 : _c.onSubmit) === null || _d === void 0 ? void 0 : _d.call(_c);
            case 'Escape':
                input.blur();
                hideKeyboard();
                break;
            ...
            default:
                ...
                (_e = inputConfig.get(focusedElementId)) === null || _e === void 0 ? void 0 : _e.onChange(input.value + keyValue);
                break;
        }
    }
    keyClicked = false;
