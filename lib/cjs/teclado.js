...
function teclado(options = {}) {
    ...
    return {
        ...
        hideKeyboard,
        setKeyboardType,
        on(elmentId, changeCallback, submitCallback) {
...
function onKeyDownListener(event) {
    ...
    if (input) {
        switch (event.key) {
            case 'Backspace':
                (_a = changeHandlers.get(focusedElementId)) === null || _a === void 0 ? void 0 : _a.onChange(input.value.slice(0, -1));
                break;
            case 'Delete':
                (_b = changeHandlers.get(focusedElementId)) === null || _b === void 0 ? void 0 : _b.onChange('');
                break;
            case 'Enter':
                (_d = (_c = changeHandlers.get(focusedElementId)) === null || _c === void 0 ? void 0 : _c.onSubmit) === null || _d === void 0 ? void 0 : _d.call(_c);
            case 'Escape':
                input.blur();
                hideKeyboard();
                break;
            ...
            default:
                ...
                (_e = changeHandlers.get(focusedElementId)) === null || _e === void 0 ? void 0 : _e.onChange(input.value + keyValue);
                break;
        }
    }
    keyClicked = false;
